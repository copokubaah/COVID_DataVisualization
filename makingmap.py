## THIS SCRIPT TAKES FRAME-GENERATED FIGURES AND CREATES A VIDEO OUT OF THE IMAGES
...
fps = 60
out = cv.VideoWriter('D:/YoutubeChannel/CoronaVirus/Map{}_{}_{}.avi'.format(cont, name, fps),
        ...
        for num in np.arange(intpolnum):
            if (dayidx == where_to_start) and (num == 0):
                for _ in np.arange(fps*2):
                    figname = 'D:/YoutubeChannel/CoronaVirus/CoronaImages/{}/{}{}-{}.png'.format(cont, month, day, num)
